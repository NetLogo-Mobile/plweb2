...
function getUserId(): string {
  ...
  return (
    userInfo?.ID || userAuthInfo?.userId || userAuthInfo?.userID || userAuthInfo?.ID || 'anonymous'
  )
}
...
const requestHistoryMap = new Map<string, number[]>(Object.entries(initialPayload.records))
