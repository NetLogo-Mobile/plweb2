async function pltxt2htm(moduleArg = {}) {
  ...
  function assignWasmExports(wasmExports) {
    _ver_major = Module["_ver_major"] = wasmExports["h"];
    _ver_minor = Module["_ver_minor"] = wasmExports["i"];
    _ver_patch = Module["_ver_patch"] = wasmExports["j"];
    _advanced_parser = Module["_advanced_parser"] = wasmExports["k"];
    _fixedadv_parser = Module["_fixedadv_parser"] = wasmExports["l"];
    _common_parser = Module["_common_parser"] = wasmExports["m"];
    _deallocate = Module["_deallocate"] = wasmExports["n"];
