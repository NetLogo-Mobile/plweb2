export default {
  ...
  activity: {
    ...
    conditions: {
      click: 'アクティビティページを訪問',
      attendance: '{days}日連続チェックイン',
      upgradeAttendance: '{days}日連続ログイン',
      share: '作品をシェア',
      comment: 'コメントを投稿',
      star: '作品をお気に入り',
      follow: 'ユーザーをフォロー',
      ...
      break: 'チェックイン中断',
      publish: '作品を公開',
      fallback: 'アクティビティ条件を達成',
    },
    bonuses: {
      gold: 'ゴールド',
      experience: '経験値',
      diamond: 'ダイヤ',
      fragment: 'エレメントフラグメント',
      experiment: '実験ポイント',
    },
    rewardReceived: '報酬を受け取りました',
    claimFailed: '受け取りに失敗しました',
    unsupportedEntry: 'このアクティビティ入口はウェブではまだサポートされていません。',
    empty: '参加できるデイリーアクティビティはありません。',
    descriptionFallback: 'デイリーアクティビティに参加して報酬を受け取りましょう。',
    close: '閉じる',
    ariaLabel: 'デイリーアクティビティ',
    list: 'アクティビティ一覧',
  },
  cookieNotice: {
