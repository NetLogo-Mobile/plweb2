export default {
  ...
  activity: {
    daily: 'Activités quotidiennes',
    checkIn: 'Pointage',
    activity: 'Activité',
    upgrade: 'Mise à jour',
    dailyCheckIn: 'Pointage quotidien',
    limitedActivity: 'Activité à durée limitée',
    versionUpdate: 'Mise à jour de version',
    view: 'Voir',
    day: 'Jour {day}',
    claimed: 'Réclamé',
    ...
    notMet: 'Non atteint',
    conditions: {
      click: "Visiter la page de l'activité",
      attendance: 'Pointer pendant {days} jours',
      upgradeAttendance: 'Se connecter pendant {days} jours',
      share: "Partager une œuvre",
      comment: 'Publier un commentaire',
      star: "Favoriser une œuvre",
      follow: 'Suivre un utilisateur',
      bind: 'Lier le compte',
      break: 'Pointage interrompu',
      publish: "Publier une œuvre",
      fallback: "Remplir la condition de l'activité",
    },
    bonuses: {
      gold: "Pièces d'or",
      experience: 'Expérience',
      diamond: 'Diamants',
      fragment: "Fragments d'élément",
      experiment: "Points d'expérience",
    },
    rewardReceived: 'Récompense réclamée',
    claimFailed: 'Échec de la réclamation',
    unsupportedEntry: "Cette entrée d'activité n'est pas encore prise en charge sur le web.",
    empty: 'Aucune activité quotidienne disponible.',
    descriptionFallback: 'Participez aux activités quotidiennes pour gagner des récompenses.',
    close: 'Fermer',
    ariaLabel: 'Activités quotidiennes',
