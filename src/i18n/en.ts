export default {
  ...
  activity: {
    ...
    limitedActivity: 'Limited-time Activity',
    ...
    notMet: 'Not Met',
    conditions: {
      click: 'Visit activity page',
      attendance: 'Check in for {days} days',
      upgradeAttendance: 'Log in for {days} days',
      share: 'Share a work',
      comment: 'Leave a comment',
      star: 'Favorite a work',
      follow: 'Follow a user',
      bind: 'Bind account',
      break: 'Break in check-in',
      publish: 'Publish a work',
      fallback: 'Complete activity condition',
    },
    bonuses: {
      gold: 'Gold',
      experience: 'Experience',
      diamond: 'Diamond',
      fragment: 'Element Fragments',
      experiment: 'Experiment Points',
    },
    rewardReceived: 'Reward claimed',
    claimFailed: 'Claim failed',
    unsupportedEntry: 'This activity entry is not supported on the web yet.',
    empty: 'No daily activities available.',
    descriptionFallback: 'Join daily activities to earn rewards.',
    close: 'Close',
    ariaLabel: 'Daily Activities',
    list: 'Activity list',
  },
  cookieNotice: {
    title: 'Cookie notice',
