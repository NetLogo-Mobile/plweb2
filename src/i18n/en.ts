export default {
  ...
  democracy: {
    sensitive: {
      days: 'Ban duration (days)',
      until: 'Banned until',
      traceContributor: 'Trace contributor',
      banContributor: 'Ban contributor',
      disclose: 'Disclose account publicly',
      discloseConfirm:
        'The contributor’s account and disclosure reason will be visible to all visitors. Confirm disclosure?',
      publicIdentity: 'Publicly disclosed account',
      manageContributor: 'Manage contributor',
    },
    invitation: {
      title: 'Investigation team invitation',
      accept: 'Accept invitation',
      decline: 'Decline invitation',
      unavailable: 'This invitation is unavailable for the current account.',
    },
    ...
    create: {
      ...
      votingLocked: 'Voting has started. Authors can no longer edit. Users with explicit developer permission may revise the title and content; voting options, timing and existing votes remain unchanged.',
      editAction: 'Edit matter',
      ...
      aliasPlaceholder: '2–16 characters; one editable alias per person',
      ...
      postingRevoked:
        'Anonymous publishing has been revoked for this account. Suggestions and formal matters are disabled.',
      kind: 'Matter category',
      participation: 'Participation method',
      consultation: 'Opinion collection',
      vote: 'Vote',
      anonymousConsultationOnly:
        'Anonymous suggestions only collect opinions and cannot open a vote.',
      votePlanTitle: 'Scheduled vote',
      votePlanNotice:
        'Questions remain open until the scheduled start, when the vote appears automatically.',
      voteStart: 'Vote start time',
      loadFailed: 'Unable to load this matter for editing or you lack permission',
      subject: 'Title',
    ...
    moderation: {
      title: 'Permission demo: identity audit',
      trace: 'Real account visible to authorized moderators only: {id}',
      revoke: 'Revoke anonymous publishing',
      restore: 'Restore anonymous publishing',
    },
    management: {
      title: 'Matter management and audit',
      notice: 'Sensitive actions require a reason and are appended to the server audit trail.',
      reasonPlaceholder: 'Give a reason for tracing, banning, disclosure, or deletion (6+ characters)',
      identityTitle: 'Anonymous identity controls',
      trace: 'Trace publisher with authorization',
      revoke: 'Revoke publishing',
      restore: 'Restore publishing',
      alias: 'Public alias',
      account: 'Account ID',
      warnAccount: 'Warn real account',
      banAccount: 'Ban real account',
      unbanAccount: 'Lift account ban',
      accountStatus: 'Account status',
      accountBanned: 'Banned',
      accountActive: 'Active',
      publishingStatus: 'Democracy wall publishing',
      publishingRevoked: 'Revoked',
      publishingActive: 'Active',
      contentActions: 'Matter action',
      deleteMatter: 'Delete matter',
      deleteNotice: 'Deletion removes public access while retaining audit and appeal records.',
      deleteConfirm: 'Delete this matter? Its public content will be removed immediately.',
      confirmDelete: 'Confirm deletion',
      deleted: 'Matter deleted with audit records retained',
      investigationTitle: 'Investigation team invitations',
      investigationNotice: 'Available for oversight matters; invitees join after accepting.',
      invitePlaceholder: 'Enter a 24-character user ID or profile link',
      inviteAction: 'Send invitation',
      inviteSent: 'Investigation team invitation sent',
      investigationEmpty: 'No investigation team invitations yet',
      invitePending: 'Awaiting acceptance',
      inviteAccepted: 'Joined',
      inviteDeclined: 'Declined',
      workflowTitle: 'Matter stage',
      targetPlaceholder: 'Select the next stage',
      voteOptions: 'Voting options',
      optionPlaceholder: 'Option {number}',
      removeOption: 'Remove option {number}',
      addOption: 'Add option',
      optionLimit: 'Enter at least 2 and up to {max} options.',
      voteDeadline: 'Voting deadline',
      multiple: 'Allow multiple choices',
      createVote: 'Create vote and enter voting',
      transition: 'Apply stage change',
      auditTitle: 'Audit trail',
      refreshAudit: 'Refresh',
      noAudit: 'No audit entries yet',
      saved: 'Management action saved',
      failed: 'Management action failed; check permission and stage state',
      stages: {
    ...
    report: {
      action: 'Report matter',
      title: 'Report Democracy Wall matter',
      notice: 'Reports go to authorized Democracy Wall reviewers and retain a handling record.',
      placeholder: 'Describe the content, location, and possible impact (10+ characters)',
      cancel: 'Cancel',
    ...
    matter: {
      ...
      noContributions: 'No suggestions or questions yet',
      contributionLoadFailed: 'Failed to load suggestions and questions',
      contributionSubmitFailed: 'Failed to send. Please try again later',
      readOnly: 'Historical record is read-only',
      noVotes: 'This matter has not entered the voting stage',
      voteScheduled: 'Questions are open. Voting will begin automatically at {date}.',
    },
    ...
    release: {
      readOnly:
        'The democracy wall is in a read-only rollout. Publishing and moderation are disabled.',
      checkingAccess: 'Checking anonymous publishing access with the server…',
      accessFailed: 'Publishing permissions could not be confirmed. Please try again.',
    },
    vote: {
    ...
    demo: {
      ...
      reset: 'Reset votes',
      switchToAdmin: 'Open admin view',
      switchToUser: 'Return to user view',
